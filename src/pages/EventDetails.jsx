        ...
        {localStorage.getItem('adminToken') && (
          <div className="mb-4 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
            <div className="flex items-start">
              ...
              <div>
                <p className="text-sm font-medium text-yellow-800">Admin accounts cannot book tickets</p>
                <p className="text-xs text-yellow-700 mt-1">Logout & login as a user to book tickets.</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <div className="flex-1">
              ...
              {qtyError ? (
                ...
                <p className="text-xs text-gray-500 mt-1">{event.available_seats} seats available</p>
              )}
            </div>
